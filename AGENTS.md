...
- **[`app/dlock/__init__.py`](app/dlock/__init__.py)** - Distributed locking using PostgreSQL advisory locks
...
4. **Distributed Locking**: PostgreSQL advisory locks for multi-node coordination (see [`app/dlock/__init__.py`](app/dlock/__init__.py))
